...
public class Liste {
	 ...
	 * 
	 * Si la position voulue dépasse le nombre d'éléments dans la liste, 
	 ...
	 * @param positionCourante Position de l'insertion.
	 *
	 */
	public void insererALaPosition(Object element, int positionCourante){
		...
		if(nbElements < liste.length){
			...
			if(positionCourante < nbElements) {
	 ...
	 */
	public void supprimer(int positionCourante){
	 ...
	 */
	public Object getElement(int positionCourante){
